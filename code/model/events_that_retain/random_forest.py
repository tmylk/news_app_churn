...
conn_str = "redshift+psycopg2://***.redshift.amazonaws.com:5439/db"
...
def get_output(rf, name, data):
    ...
    print "Percent of predicted staying out of all staying :", \
        float(pred_stay) / act_stay
...
def plot_feature_importance_with_error_bars(X, rf, ntrees):
    ...
    fi_mean, fi_std, feature_name_sorted =\
        zip(*sorted(zip(fi_mean, fi_std, data.columns), reverse=True))
...
# OOB: 0.957525955514
# Top 5 features:
# Index([u'app_viewed_day_avg', u'time_to_10_agg_day_avg',
#    u'story_viewed_day_avg', u'app_navigation_clicked_day_avg',
# u'time_to_25_agg_day_avg'], dtype='object')
# ======
# Downsampled
# ======
...
# OOB: 0.938201478237
# Top 5 features: Index([u'time_to_10_agg_day_avg', u'app_viewed_day_avg',
# u'app_navigation_clicked_day_avg', u'story_viewed_day_avg',
# u'time_to_50_agg_day_avg'], dtype='object')
