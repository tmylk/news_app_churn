...
class EventFeaturesTestBaseClass(TestCase):
    ...
    n.assert_equal(df_test[(df_test.date == "2015-01-22") &  (df_test.event_type== "story completion")]["day_total"].values[0], 4)
    ...
    df_test = pd.read_sql("""SELECT * FROM Story_Completion_agg_day_stats""", engine)
    ...
    n.assert_equal(df_test[(df_test.week == 4) &  (df_test.event_type== "story completion")]["week_total"].values[0], 29)
    ...
    #--------------------------------------+---------------------+-------+-------------                                                   
    # 681CFA45-B526-4FE4-A2DF-F73F2D0CF674 | 24.6666666666666667 |   148 |           6
    n.assert_equal(len(df_test), 1)    
