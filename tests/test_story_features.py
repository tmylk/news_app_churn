...
def test_create_all_day_story_stats():
    ...
    check_one_row_per_user("story_4368f127_e34b_44d7_807e_5f1a72638a79_day_stats")
#           distinct_id              | story completion |               story id               | agg_day_time_total | agg_day_time_avg | agg_day_count | agg_day_count_avg
# --------------------------------------+------------------+--------------------------------------+--------------------+------------------+---------------+-------------------
#  681CFA45-B526-4FE4-A2DF-F73F2D0CF674 | 100              | 4368f127-e34b-44d7-807e-5f1a72638a79 |               3000 |             3000 |             1 |                 1
